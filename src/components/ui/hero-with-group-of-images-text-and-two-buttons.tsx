...
import { Button, Badge, Flex, Icon, Heading, Text } from '@/once-ui/components';
      ...
      <div className="relative w-full py-20 lg:py-32">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 gap-12 items-center md:grid-cols-2">
            <div className="flex gap-6 flex-col">
              ...
              <div className="flex gap-4 flex-col">
                ...
                <Text 
                  ...
                  className="max-w-md text-left animate-slide-up [animation-delay:150ms]"
                >
              ...
              <div className="flex flex-row gap-4 animate-slide-up [animation-delay:300ms]">
                <Button 
                  variant="secondary" 
                  size="l"
                  prefixIcon="phone"
              ...
              <div className="flex items-center gap-4 pt-4 animate-slide-up [animation-delay:450ms]">
            ...
            <div className="grid grid-cols-2 gap-8 animate-fade-in [animation-delay:600ms]">
